...
function initMenu() {
    ...
    if (!hamburguesa || !menu) {
        console.log("No encuentra los elementos");
        return;
    }
    ...
    carrito.forEach((item, index) => {
        ...
        lista.innerHTML += `
            <div class="item-carrito">
                ...
                <button class="restar" data-index="${index}">
                    -
                </button>

                <span>${item.cantidad}</span>

                <button class="sumar" data-index="${index}">
                    +
                </button>
...
function actualizarTotales() {
    ...
    const formatoCRC = new Intl.NumberFormat(
        "es-CR",
        {
            style: "currency",
            currency: "CRC",
    ...
    if (subtotalHTML) {
        subtotalHTML.textContent =
            formatoCRC.format(subtotal);
    }

    if (ivaHTML) {
        ivaHTML.textContent =
            formatoCRC.format(Math.round(iva));
    }
